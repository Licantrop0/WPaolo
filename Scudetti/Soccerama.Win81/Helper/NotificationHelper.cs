...
namespace Soccerama.Win81.Helpers
{
    public static class NotificationHelper
    {
        ...
        private static XmlDocument SimpleWide
        {
            get
            {
                if (_simpleWide == null)
                {
                    _simpleWide = TileUpdateManager.GetTemplateContent(TileTemplateType.TileWide310x150Image);
        ...
        private static XmlDocument DynamicWide
        {
            get
            {
                ...
                {
                    _dynamicWide = TileUpdateManager.GetTemplateContent(TileTemplateType.TileWide310x150ImageAndText01);
