...
namespace WizardMario
{
    ...
    public class GameplayScreen : GameScreen
    {
        ...
        public override void Activate(bool instancePreserved)
        {
            ...
            {
                if (content == null)
                    content = new ContentManager(ScreenManager.Game.Services, "Content");  // WizardMarioContent ?
                                                       ...
                                                       bool coveredByOtherScreen)
        {
            ...
            if (IsActive)
            {
                ...
                board.Update((float)gameTime.ElapsedGameTime.TotalSeconds, "none");
